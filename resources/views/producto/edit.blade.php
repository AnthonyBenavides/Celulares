	...
	<div class="row" >
		<div class="col-sm">
			<div class="card" style="margin-top: 10px;">
				<div class="card-body">
					<form method="POST" action="/producto/{{$producto->id_produ}}" accept-charset="UTF-8" style="display:inline">
						@csrf			
						<input type="hidden" name="_method" value="PUT">
						<div class="form-group">
							<label for="produ_nom">producto</label>
							<input type="text" value = '{{$producto->produ_nom}}' class="form-control" name="produ_nom"/>
						</div>

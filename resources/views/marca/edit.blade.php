...
@section('title', 'Actualización de marcas')
@section('title2', 'Actualización de marcas')
@section('content')
	...
	<div class="row" >
		<div class="col-sm">
			<div class="card" style="margin-top: 10px;">
				<div class="card-body">
					<form method="POST" action="/marca/{{$marca->id_marca}}" accept-charset="UTF-8" style="display:inline">
						@csrf			
						<input type="hidden" name="_method" value="PUT">
						<div class="form-group">
							<label for="nom_marca">Nombre Marca</label>
							<input type="text" value = '{{$marca->nom_marca}}' class="form-control" name="nom_marca"/>
						</div>
